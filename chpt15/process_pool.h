...
class process {
 ...
 public:
  pid_t m_pid;
  int m_pipefd[2];  // pipe with parent process
};
...
processpool<T>::processpool(int listenfd, int process_number)
  ...
  // create process_number sub_processes which connect parent process by pipe
...
void processpool<T>::run_child() {
  ...
  // child get client connection notified by parent through pipe
